...
// PLACEHOLDER — replace with real schema.sql content once Adelle syncs
export const schemaScript: TerminalScript = {
  title: 'schema.sql',
  lines: [
    {type: 'output', text: 'CREATE TABLE invoices (', frameIn: 10},
    ...
    {type: 'output', text: '  total NUMERIC NOT NULL,', frameIn: 95, dim: true},
    {type: 'output', text: '  status TEXT NOT NULL,', frameIn: 115, dim: true},
    {type: 'output', text: '  processed_at TIMESTAMPTZ DEFAULT now(),', frameIn: 135, dim: true},
